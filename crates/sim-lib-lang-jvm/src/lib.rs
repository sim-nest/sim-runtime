...
pub use code::{
    ...
    PreparedJvmPolicy, PreparedMicroOp, PreparedValueGuarantee, PreparedVerificationGuarantee,
    RootEffect, VerificationPreparation, prepare_code, prepare_code_bound, prepare_code_verified,
};
pub use constructor::{
...
pub use linker::{
    ...
    GeneratedLambdaMemberRole, JavaLambdaCallOutcome, JavaLambdaCallable, JvmAdaptation,
    JvmAdaptationError, JvmFunctionPlan, JvmFunctionPolicyBody, LambdaBootstrapError,
    LambdaBootstrapPlan, LambdaBootstrapProtocol, LambdaFactoryCache, LambdaFactoryError,
    LambdaInvocationOutcome, LambdaMethodCall, LambdaMethodPipeline, LambdaProtocolTail,
    LambdaSerializationError, LinkageCache, LinkageFailure, LinkageState, LocatedJvmAdaptation,
    ManagedLambdaFactory, ManagedLambdaInstance, MethodIdentity, ResolvedBootstrapArgument,
    ResolvedDirectHandle, SelectedLambdaMember, SimFunctionalAdapter, SiteKey,
    StatelessLambdaIdentity, adapt_sim_callable_as_functional_interface, compile_jvm_function_plan,
    decode_lambda_bootstrap, discover_functional_interface, executor_admitted_lambda_protocols,
    invoke_lambda_member, jvm_functional_adapter_capability, resolve_direct_handle,
...
pub use surface::{
    JVM_DECLARED_ABSENCES, JvmBrowse, JvmInvocationError, JvmLanguageLib, JvmSurface,
    install_jvm_language_lib, jvm_browse_capability, jvm_invoke_capability, jvm_language_profile,
};
