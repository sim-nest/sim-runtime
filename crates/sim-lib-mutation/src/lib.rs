...
pub use managed::{
    ...
    EdgeVisitor, EphemeronMutationError, HardCappedRetainPolicy, ManagedArena, ManagedHandle,
    ManagedId, ManagedNode, ManagedObject, ManagedRole, RootId, RootedHandle, SafepointReceipt,
    StrongEdgeMutationError, TeardownReceipt, TraceContractVersion, TraceSnapshot, TypedEdgeId,
    WeakEdgeMutationError, WeakHandle,
};
