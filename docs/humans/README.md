...
| `feature/sim-runtime/guarded-operations` | `crate/sim-lib-operation-gate` | 3 | Guard domain-neutral operations with explicit capability and exact approval, then durably retain canonical intent, separate grants and attempts, dispatch-before-performance, and raw performer receipts. |
