...
| --- | --- | ---: | --- |
| `feature/sim-runtime/javascript-core-profile` | `crate/sim-lib-lang-javascript` | 0 | Directly evaluate bounded codec/javascript core forms with ordinary objects, collections, exact UTF-16 strings, canonical JSON policy, and a fail-closed RegExp subset through shared runtime organs. |
