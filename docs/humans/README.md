...
| `feature/sim-runtime/incremental-query-core` | `crate/sim-incremental-core` | 4 | Provide the generic memo graph, the one proof-producing dataflow fixpoint engine, qualified semantic projection, and prediction-only closure assays over canonical SIM facts. |
...
| `feature/sim-runtime/local-check-contract` | `crate/sim-lib-exec` | 1 | Bind exact installed commands and every execution resource, bound, output, network grant, and cleanup rule behind a portable checker port. |
...
| `feature/sim-runtime/guarded-operations` | `crate/sim-lib-operation-gate` | 4 | Guard domain-neutral operations with explicit capability and exact approval, then reconcile durable fenced dispatch against independent postcondition evidence. |
...
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/Cargo.lock`
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/Cargo.toml`
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/README.md`
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/expected.txt`
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/recipe.toml`
- `crates/sim-lib-operation-gate/recipes/01-basics/crash-matrix/src/main.rs`
...
### `feature/sim-runtime/local-check-contract`
...
Specimen `spec-test/sim-runtime/crates/sim-lib-operation-gate/src/durable_tests` is checked by `cargo test`.

Source `crates/sim-lib-operation-gate/src/durable_tests.rs`:
...
Specimen `spec-test/sim-runtime/crates/sim-lib-operation-gate/src/lifecycle_tests` is checked by `cargo test`.

Source `crates/sim-lib-operation-gate/src/lifecycle_tests.rs`:
